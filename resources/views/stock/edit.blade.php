...
<div class="form-contant">  
    <form method="post" action="/stock/update/{{$data->id}}">
        {{-- @method('put') --}}
        @csrf
        ...
        <div class="form-group">
            <label for="name">Enter QTY</label>
            <input type="text" name="qty" value="{{$data->qty}}" class="form-control @error('qty') border border-danger @enderror" placeholder="Enter qty">
            </div>
